...
<head>
	...
	<title>Welcome to TheraTrack</title>
...
<body>
	<div class="wrapper">
		<nav class="navbar navbar-expand-lg navbar-light">
			<div class="container">
				<a class="navbar-brand" href="#">Thera<b>Track </b></a>
		...
		<div class="jumbotron jumbotron-fluid">
			<div class="container">
				<h2 class="jumbotron-title">Caring for Every Unique Need</h2>
				<p>Helping families and therapists support children with autism—every step of the way.</p>
			</div>
		</div>
			...
			<div class="container">
				<div class="row slideanim">
					<div class="col-6 col-md-4">
						...
						<div class="desc">
							<h4 class="mb-3">Support, Just a Tap Away</h4>
							<p class="paragraph">
								Easily book therapy sessions and support services with just one tap. 
								Your therapist knows exactly where and when to meet you. 
								After each session, there’s no hassle—everything from reminders to payments is handled smoothly within the app.
							</p>
						</div>
					</div>
					<div class="col-6 col-md-4">
						...
						<div class="desc">
							<h4 class="mb-3">Consistent Care, Anytime</h4>
							<p class="paragraph">
								Whether it’s a weekly appointment, a last-minute need, or a follow-up session, THERATRACK is here for you. 
								No complicated scheduling—get the care your child needs, when they need it.
							</p>
						</div>
					</div>
					<div class="col-6 col-md-4">
						...
						<div class="desc">
							<h4 class="mb-3">Track Progress with Confidence</h4>
							<p class="paragraph">
								Stay connected with your child’s development. View reports from therapists, 
								monitor appointment history, and stay informed every step of the way. Whether it's regular therapy or special support, THERATRACK grows with your child.
							</p>
						</div>
					</div>
				</div>
			...
			<div id="carouselContent" class="carousel slide" data-ride="carousel">
				<div class="carousel-inner text-center" role="listbox">
					<div class="carousel-item active">
						...
						<p>TheraTrack is easy to manage therapy session.</p>
						<div class="quote">
							<p><strong>-Sarah</strong><br>CEO at Mighty Schools.</p>
						</div>
					</div>
					<div class="carousel-item">
						<div class="avatar"><img
								src="https://img.icons8.com/color/48/000000/circled-user-female-skin-type-7.png"></div>
						<p>The system helps us to manage therapy autism care.</p>
						<div class="quote">
							<p><strong>- TheraTrack</strong><br>CEO at Company.</p>
						</div>
					</div>
				</div>
		...
		<section id="patient">
			<div class="container">
				<div class="row slideanim">
					...
					<div class="col-7">
						<h1>Download the TheraTrack app</h1>
						<p>Book appointments and Therapy checkups;<br>Consult your doctor</p>
	...
	<footer class="footer">
		<div class="upper-footer">
			<div class="container">
				<div class="row">
					<div class="col-3">
						<a class="navbar-brand" href="#">TheraTrack</a>
					</div>
					<div class="col-3">
						<h5>Product</h4>
							<ul>
					...
					<div class="col-3">
						...
						<ul>
							<li class=""><a href="#">TheraTrack@gmail.com</a></li>
